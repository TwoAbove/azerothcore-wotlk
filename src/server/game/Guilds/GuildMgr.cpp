...
void GuildMgr::LoadGuilds()
{
    ...
    LOG_INFO("server.loading", "Filling bank tabs with items...");
    {
        ...
        QueryResult result = CharacterDatabase.Query("SELECT creatorGuid, giftCreatorGuid, count, duration, charges, flags, enchantments, randomPropertyId, durability, playedTime, text, bonusSeed, "
                             //   12       13     14      15         16
