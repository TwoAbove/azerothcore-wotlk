...
public:
    ...
    Item* StoreNewItem(ItemPosCountVec const& pos, uint32 item, bool update, int32 randomPropertyId = 0, bool refund = false, uint32 bonusSeed = ITEM_BONUS_SEED_UNSET);
    Item* StoreNewItem(ItemPosCountVec const& pos, uint32 item, bool update, int32 randomPropertyId, AllowedLooterSet& allowedLooters, bool refund = false, uint32 bonusSeed = ITEM_BONUS_SEED_UNSET);
    ...
    void DestroyItem(uint8 bag, uint8 slot, bool update, CharacterDatabaseTransaction* trans = nullptr);
